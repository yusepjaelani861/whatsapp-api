...
--
-- Host: localhost
-- Waktu pembuatan: 25 Okt 2022 pada 11.29
...
--
-- Struktur dari tabel `client_sessions`
--
...
--
-- Indeks untuk tabel `client_sessions`
--
ALTER TABLE `client_sessions`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `client_sessions_name_unique` (`name`);
...
--
-- AUTO_INCREMENT untuk tabel `client_sessions`
--
ALTER TABLE `client_sessions`
